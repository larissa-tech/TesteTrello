...
var formatRequest = function (options) {
    ...
    var hasBearer = auth === null || auth === void 0 ? void 0 : auth.bearer;
    if (!showCredentials && hasPassword && hasBearer) {
        return formatJSon(__assign(__assign({}, options), { auth: __assign(__assign({}, options.auth), { bearer: '*****', password: '*****' }) }));
    }
        ...
        return formatJSon(__assign(__assign({}, options), { auth: __assign(__assign({}, options.auth), { bearer: '*****' }) }));
    }
